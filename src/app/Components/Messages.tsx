    ...
    <div>
      {sender === 'user' ? (
        <div className="flex justify-end items-start gap-2.5 p-6">
          ...
          <Image className="w-8 h-8 rounded-full" src={userImage} alt="User image" width={32} height={32} />
        </div>
      ) : (
        <div className="flex items-start gap-2.5 p-6">
          <Image className="w-8 h-8 rounded-full" src={chatBotImage} alt="Chatbot image" width={32} height={32} />
